        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/categories?domain=sports" className="hover:text-accent transition-colors">Sports</Link></li>
              <li><Link href="/categories?domain=music" className="hover:text-accent transition-colors">Music</Link></li>
              <li><Link href="/categories?domain=politics" className="hover:text-accent transition-colors">Politics</Link></li>
              <li><Link href="/categories?domain=entertainment" className="hover:text-accent transition-colors">Entertainment</Link></li>
              <li><Link href="/categories?domain=science" className="hover:text-accent transition-colors">Science</Link></li>
            </ul>
          </div>
